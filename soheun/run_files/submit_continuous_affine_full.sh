...
smoke_job=$(
    sbatch --parsable \
        ...
        --wrap='cd /home/export/soheuny/SRFinder/soheun && export OMP_NUM_THREADS=1 OPENBLAS_NUM_THREADS=1 MKL_NUM_THREADS=1 && /home/export/soheuny/.conda/envs/coffea_torch/bin/python run_files/run_continuous_affine_full.py --shard-index 0 --n-shards 1 --limit 1'
)
array_job=$(
    sbatch --parsable \
