...
parser.add_argument(
    "-pi",
    "--pathin",
    default="../../events/MG2/TTree/bbbj.root",
    type=str,
    help="Path to TTree.",
)
parser.add_argument(
...
parser.add_argument(
    ...
    default=3,
    type=int,
    help="Number of b-quarks (typically 2, 3 or 4).",
)
...
for i in range(tree.GetEntries()):
    ...
    for j in range(0, 4):
        ...
        temp.append(tree.jetEnergy[j])  # modified
...
CR2b = np.array(lCR2b)
SR2b = np.array(lSR2b)
all_events = np.array(lall_events)
...
np.save(args.pathout + "/all" + str(args.bquarks) + "b.npy", all_events)
