...
def make_df(tree, fourTag=True, verbose=False):
    ...
    for iEvt in list(range(iEvtStart, iEvtEnd)):
        ...
        data["Jet0_pt"].append(copy(tree.GenJet_pt[0]))
        data["Jet1_pt"].append(copy(tree.GenJet_pt[1]))
        data["Jet2_pt"].append(copy(tree.GenJet_pt[2]))
        data["Jet3_pt"].append(copy(tree.GenJet_pt[3]))
        data["Jet0_eta"].append(copy(tree.GenJet_eta[0]))
        data["Jet1_eta"].append(copy(tree.GenJet_eta[1]))
        data["Jet2_eta"].append(copy(tree.GenJet_eta[2]))
        data["Jet3_eta"].append(copy(tree.GenJet_eta[3]))
        data["Jet0_phi"].append(copy(tree.GenJet_phi[0]))
        data["Jet1_phi"].append(copy(tree.GenJet_phi[1]))
        data["Jet2_phi"].append(copy(tree.GenJet_phi[2]))
        data["Jet3_phi"].append(copy(tree.GenJet_phi[3]))
        # jetMasses = []
        # for i in range(4):
        #     p_square = tree.GenJet_pt[i] ** 2 * (np.cosh(tree.GenJet_eta[i]) ** 2)
        #     jmass = np.sqrt(tree.jetEnergy[i] ** 2 - p_square)
        #     print(jmass)
        #     jetMasses.append(jmass)

        # data["Jet0_m"].append(0.0)
        # data["Jet1_m"].append(0.0)
        # data["Jet2_m"].append(0.0)
        # data["Jet3_m"].append(0.0)
        data["Jet0_m"].append(copy(tree.GenJet_mass[0]))
        data["Jet1_m"].append(copy(tree.GenJet_mass[1]))
        data["Jet2_m"].append(copy(tree.GenJet_mass[2]))
        data["Jet3_m"].append(copy(tree.GenJet_mass[3]))
        ...
        data["weight"].append(copy(tree.genWeight))
